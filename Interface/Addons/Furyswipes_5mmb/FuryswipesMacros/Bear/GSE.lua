			...
			["MacroVersions"] = {
				{
					"/cast [nomod] Execute", -- [1]
					"/cast [nomod] Overpower", -- [2]
					"/cast [nomod] whirlwind", -- [3]
					"/castsequence [nomod] reset=target/combat  Cleave,Cleave", -- [4]
					"/castsequence [nomod] reset=target/combat  Bloodrage, Battle Shout", -- [5]
					["LoopLimit"] = 1,
					["PostMacro"] = {
					},
					["Head"] = false,
			...
			["MacroVersions"] = {
				{
					...
					["KeyPress"] = {
						"/cancelform [stance,mod:ctrl]", -- [1]
						"/cast [mod:ctrl,nostance] 783", -- [2]
					},
				}, -- [1]
			},
			["SpecID"] = 11,
			...
			["MacroVersions"] = {
				{
					...
					["KeyPress"] = {
						"/cast [nomod,@target,exists] 16979", -- [1]
			...
			["MacroVersions"] = {
				{
					...
					["KeyPress"] = {
						...
						"/Startattack [nomod,@target,exists]", -- [3]
					},
					["PostMacro"] = {
					},
					["PreMacro"] = {
			...
			["MacroVersions"] = {
				{
					...
					"/cast [@party1] Remove Curse", -- [2]
					"/cast [@party2] Remove Curse", -- [3]
					"/cast [@party3] Remove Curse", -- [4]
					"/cast [@party4] Remove Curse", -- [5]
					["Combat"] = false,
					["Head"] = false,
					["Neck"] = false,
					["Belt"] = false,
