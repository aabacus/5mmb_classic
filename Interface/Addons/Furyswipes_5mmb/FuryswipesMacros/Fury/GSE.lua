...
GSELibrary = {
	{
		...
		["ARMS_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] whirlwind", -- [1]
					"/castsequence [nomod] reset=target/combat  Cleave,Cleave", -- [2]
					"/castsequence [nomod] reset=target/combat  Bloodrage, Battle Shout", -- [3]
					["LoopLimit"] = 1,
					["Trinket1"] = false,
					["Head"] = false,
					["Neck"] = false,
					...
					["PreMacro"] = {
						"/cast [nocombat,nomod] Battle Stance", -- [1]
					},
					["PostMacro"] = {
					},
				}, -- [1]
			...
			["MacroVersions"] = {
				{
					...
					"/cast [nomod] 20660", -- [2]
					"/cast [nomod,nochanneling] 23881", -- [3]
					"/cast [nomod,nochanneling] 8205", -- [4]
					"/cast [nomod,nochanneling] 7887", -- [5]
					"/cast [nomod,nochanneling] 11565", -- [6]
					"/castsequence [nomod,nochanneling] reset=target/combat  2687, 11549", -- [7]
					"/cast [nomod,nochanneling] 18499", -- [8]
					["LoopLimit"] = 1,
					["PostMacro"] = {
						"/castsequence [nomod] reset=1  20660", -- [1]
					},
					["Head"] = false,
					["Neck"] = false,
					["Belt"] = false,
					...
					["StepFunction"] = "Sequential",
					["PreMacro"] = {
						"/cast [nocombat,nomod,nochanneling] 2457", -- [1]
					},
					["Trinket1"] = false,
				}, -- [1]
			},
			...
			["MacroVersions"] = {
				{
					...
					"/castsequence [nomod,nochanneling] reset=target/combat  2687, 11549", -- [2]
					"/cast [nomod,nochanneling] 18499", -- [3]
					"/cast [nomod,nochanneling] 7369", -- [4]
					["LoopLimit"] = 1,
					["Combat"] = true,
					["Head"] = false,
					["Neck"] = false,
					...
					["StepFunction"] = "Priority",
					["PreMacro"] = {
						"/cast [nomod,nochanneling] 2458", -- [1]
					},
					["Trinket1"] = false,
				}, -- [1]
			},
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] 20658", -- [1]
					"/cast [nomod] 1680", -- [2]
					"/castsequence [nomod] reset=target/combat  2687, 11549", -- [3]
		...
		["ARMS_MULTI"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod,nochanneling] 20658", -- [1]
					"/cast [nomod,nochanneling] 7887", -- [2]
					"/cast [nomod,nochanneling] 1680", -- [3]
					"/castsequence [nomod,nochanneling] reset=target/combat  7369, 7369", -- [4]
					"/castsequence [nomod,nochanneling] reset=target/combat  2687, 11549", -- [5]
					["LoopLimit"] = 1,
					["PostMacro"] = {
					},
					["Head"] = false,
		...
		["PROT_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] Shield Block", -- [1]
					"/cast [nomod] Shield Slam", -- [2]
					"/cast [nomod] Revenge", -- [3]
					"/cast [nomod] Sunder Armor", -- [4]
					"/cast [nomod] Cleave", -- [5]
					["Trinket1"] = false,
					["Head"] = false,
					["Neck"] = false,
					...
					["Trinket2"] = false,
					["KeyPress"] = {
						"/targetenemy [nomod,noharm,nodead]", -- [1]
						"/cast [mod:alt] Taunt", -- [2]
						"/cast [mod:ctrl] Demoralizing Shout", -- [3]
						"/cast [nomod] Charge", -- [4]
						"/cast [combat] Bloodrage", -- [5]
						"/cast [combat] Defensive Stance", -- [6]
					},
					["StepFunction"] = "Sequential",
					["PreMacro"] = {
						"/cast [nomod,nocombat] Battle Stance", -- [1]
					},
					["PostMacro"] = {
					},
				}, -- [1]
		...
		["ARMS_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] Execute", -- [1]
					"/cast [nomod] Overpower", -- [2]
					"/castsequence [nomod] reset=target/combat  Heroic Strike, Heroic Strike", -- [3]
					"/castsequence [nomod] reset=target/combat  Bloodrage, Battle Shout", -- [4]
					["LoopLimit"] = 1,
					["Trinket1"] = false,
					["Head"] = false,
					["Neck"] = false,
					...
					["PostMacro"] = {
						"/castsequence [nomod] reset=1  Execute", -- [1]
					},
				}, -- [1]
			},
			["ManualIntervention"] = false,
	...
	}, -- [1]
	{
		["RET_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [nomod] reset=25 Seal of the Crusader, Judgement", -- [1]
					["LoopLimit"] = 20,
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
		...
		["RET_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] consecration", -- [1]
					"/castsequence [nomod] reset=25 Seal of the Crusader, Judgement", -- [2]
					["LoopLimit"] = 20,
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
			...
			["MacroVersions"] = {
				{
					...
					["KeyPress"] = {
						"/startattack [nomod]", -- [1]
						"/stopattack [mod:alt]", -- [2]
						"/cast [mod:alt,@Furyswipes] Healing Touch", -- [3]
					},
				}, -- [1]
			},
			["ManualIntervention"] = false,
	...
	}, -- [2]
	{
		...
		["BM_MULTI"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] Multi-Shot", -- [1]
					"/cast [nomod] Multi-Shot", -- [2]
					"/cast [nomod] Arcane Shot", -- [3]
					"/Cast [nomod] Mongoose Bite", -- [4]
					"/cast [nomod] Raptor Strike", -- [5]
					"/cast [nomod] Auto Shot", -- [6]
					"/cast [nomod] Bite", -- [7]
					"/Cast [mod:alt] Wing Clip", -- [8]
					"/Cast [mod:alt] Concussive Shot", -- [9]
					"/Cast [mod:Shift] Hunter's Mark", -- [10]
					"/cast [nomod] Claw", -- [11]
					"/Cast [nomod] Thunderstomp", -- [12]
					"/cast [nomod] Screech", -- [13]
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
		...
		["SURV_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] Arcane Shot", -- [1]
					"/Cast [nomod] Mongoose Bite", -- [2]
					"/cast [nomod] Raptor Strike", -- [3]
					"/cast [nomod] Auto Shot", -- [4]
					"/cast [nomod] Bite", -- [5]
					"/Cast [mod:alt] Wing Clip", -- [6]
					"/Cast [mod:alt] Concussive Shot", -- [7]
					"/Cast [mod:Shift] Hunter's Mark", -- [8]
					"/cast [nomod] Claw", -- [9]
					"/Cast [nomod] Thunderstomp", -- [10]
					"/cast [nomod] Screech", -- [11]
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
	...
	}, -- [3]
	{
		["COMBAT_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [nomod] reset=combat/target Sinister Strike, Sinister Strike, Sinsiter Strike, Sinister Strike, Eviscerate", -- [1]
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
	...
	}, -- [4]
	{
		...
		["MULTI_HOLY"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod,nochanneling] !Shoot", -- [1]
					"/cast [mod:alt,@Furyswipes] Lesser Heal", -- [2]
					["PostMacro"] = {
					},
					["StepFunction"] = "Priority",
					["KeyRelease"] = {
	...
	nil, -- [6]
	{
		["RESTOSHAM_TOT"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence reset=60/combat strength of earth totem, fire nova totem,null", -- [1]
					["LoopLimit"] = 1,
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
			...
			["MacroVersions"] = {
				{
					...
					["KeyPress"] = {
						"/startattack [nomod]", -- [1]
						"/stopattack [mod:alt]", -- [2]
						"/cast [mod:alt,@Furyswipes] Healing Wave", -- [3]
					},
					["PreMacro"] = {
					},
					["KeyRelease"] = {
	...
	}, -- [7]
	{
		...
		["FROST_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] Frostbolt", -- [1]
					"/cast [nomod] Frostbolt", -- [2]
					"/cast [nomod,nochanneling] Shoot", -- [3]
					["PostMacro"] = {
					},
					["StepFunction"] = "Priority",
					["KeyPress"] = {
		...
		["FROST_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [nomod,@player,nochanneling] reset=combat  Frost Nova, Cone of Cold, Blizzard, Blizzard, Blizzard, Cone of Cold, Blizzard, Blizzard, Blizzard", -- [1]
					["PostMacro"] = {
					},
					["StepFunction"] = "Priority",
					["KeyPress"] = {
	...
	}, -- [8]
	{
		["DESTRO_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod] Shadow Bolt", -- [1]
					"/cast [nomod] Shadow Bolt", -- [2]
					"/cast [nomod] Life Tap", -- [3]
					"/cast [nomod,nochanneling] Shoot", -- [4]
					["PostMacro"] = {
					},
					["StepFunction"] = "Priority",
		...
		["DESTRO_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [nomod,nochanneling,@player] Rain of Fire", -- [1]
					"/cast [nomod,nochanneling,@player] Rain of Fire", -- [2]
					"/cast [nomod,nochanneling] Life Tap", -- [3]
					["PostMacro"] = {
					},
					["StepFunction"] = "Priority",
					["KeyPress"] = {
	...
	[11] = {
		["BOOMKIN_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [nomod,nochanneling] reset=combat/target Faerie Fire, null", -- [1]
					"/castsequence [nomod,nochanneling] reset=combat moonfire,starfire,starfire", -- [2]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyRelease"] = {
					},
					...
					["KeyPress"] = {
						"/Startattack [nomod,@target,exists,harm]", -- [1]
						"/stopattack [mod:alt]", -- [2]
						"/cast [nostance:5] Moonkin Form", -- [3]
						"/cast [mod:ctrl] Entangling Roots", -- [4]
					},
				}, -- [1]
			},
			["ManualIntervention"] = false,
		...
		["BOOMKIN_AOE"] = {
			["Talents"] = "?,?,?,?,?,?,?,",
			["Help"] = "  Heal strongestaoe?\n  ",
			["Default"] = 1,
			["SpecID"] = 11,
			["Author"] = "Furyswipesvg@gmail.com",
			["MacroVersions"] = {
				{
					"/cast [nomod,nochanneling] hurricane", -- [1]
					"/castsequence [nomod,nochanneling] reset=combat moonfire,starfire,starfire", -- [2]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyRelease"] = {
		...
		["RESTODRU_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [nomod,@Icelance] reset=combat/target renewal,regrowth,null", -- [1]
					"/cast [nomod] healing touch", -- [2]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyRelease"] = {
					},
		...
		["BOOMKIN_SETUP"] = {
			["Talents"] = "?,?,?,?,?,?,?,",
			["Help"] = "  Notthing here yet. Stop attack on alt\n  ",
			["Default"] = 1,
			["SpecID"] = 11,
			["Author"] = "Furyswipesvg@gmail.com",
			["MacroVersions"] = {
		...
		["BEAR_TANK_SINGLE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [mod:alt] Growl", -- [1]
					"/cast [mod:ctrl] Demoralizing Roar", -- [2]
					"/cast [nomod] maul", -- [3]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
			...
			["MacroVersions"] = {
				{
					...
					["KeyPress"] = {
						...
						"/stopattack [mod:alt]", -- [2]
						"/cast [nostance:5] Moonkin Form", -- [3]
						"/cast [mod:alt,@Furyswipes] healing touch", -- [4]
					},
				}, -- [1]
			},
			["ManualIntervention"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/cast [nomod] Swipe", -- [2]
					"/cast [nomod] Swipe", -- [3]
					"/cast [nomod] Demoralizing Roar", -- [4]
					"/cast [nomod] maul", -- [5]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
