...
16) type /clique and go to your healers/decursers and configure which button
does what when clicking on raid bars. (only works perfectly on 5 window
setup...other setups you'll have to configure the clique rectangle)
